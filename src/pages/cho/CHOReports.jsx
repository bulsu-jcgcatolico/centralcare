...
function groupByMonth(items, dateField, labelField, qtyField) {
  const map = {};
  items.forEach(item => {
    const month = getMonthYear(item[dateField]);
    if (!month) return;
        ...
        <main className="cho-content">
          ...
          <div className="cho-stats-grid cho-stats-grid--3">
            <div className="cho-stat-card">
              ...
              <p className="cho-stat-sub">{selectedMonth === "all" ? "All time" : selectedMonth}</p>
            </div>
            <div className="cho-stat-card">
          ...
          {loading ? (
            ...
            <div className="cho-empty-state">
              ...
              <h2 className="cho-empty-title">No Records for {selectedMonth === "all" ? "any month" : selectedMonth}</h2>
